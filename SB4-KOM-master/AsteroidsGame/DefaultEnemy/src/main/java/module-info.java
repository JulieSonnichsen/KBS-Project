...
module DefaultEnemy {
    ...
    provides IGamePluginService with dk.sdu.student.juson19.enemy.EnemyPlugin;
    provides IEntityProcessingService with dk.sdu.student.juson19.enemy.EnemyControlSystem;
}